function CartItems({data,removefunc}) {
    ...
    return (  
        ...
        <div className="flex items-center">
            ...
            <div>
                ...
                <p className="text-black-700">{data.price}</p>
        ...
        <div class="absolute bottom-1 start-1/2 -translate-x-1/2 rtl:translate-x-1/2 flex items-center text-xs text-gray-400 space-x-1 rtl:space-x-reverse">
            <svg class="w-1.5 h-1.5 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
