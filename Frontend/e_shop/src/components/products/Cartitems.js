            ...
            <div className="max-h-xs max-w-xs">
              <div className="relative flex items-center max-w-[8rem]">
                <button
                  ...
                  className="bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-600 border border-gray-600 rounded-s-lg p-2 h-10 focus:ring-gray-700 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none flex items-center justify-center"
                >
                  <svg
                ...
                <button
                  ...
                  className="bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-600 border border-gray-600 rounded-e-lg p-2 h-10 focus:ring-gray-700 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none flex items-center justify-center"
                >
                  <svg
                    className="w-3 h-3 text-white"
                    aria-hidden="true"
              ...
              <button
                type="button"
                onClick={removeItem}
                className="mt-1 py-1 text-white bg-red-600  border border-gray-600 focus:outline-none hover:bg-gray-700 focus:ring-4 focus:ring-gray-700
