  ...
  return (
    <div className="flex justify-center items-center mt-1 p-0 sm:px-0">
      <div className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center mb-0 sm:mx-5 sm:my-0 gap-3 sm:gap-4 w-full sm:w-3/5 lg:w-2/4 p-3 sm:p-5 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl shadow-indigo-500/10">
        ...
        {/* Mobile row: Dropdown + Cart side by side. sm:contents makes wrapper invisible on larger screens */}
        <div className="flex flex-row items-center gap-2 w-full sm:w-auto sm:contents">
          ...
          {/* Cart */}
          <div className="group relative flex-1 sm:flex-none sm:order-3">
            <div onClick={show_cart} className="bg-gradient-to-br from-indigo-500 to-green-600 p-2 sm:p-2.5 rounded-full text-center shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer">
              <a className="text-white text-sm sm:text-base whitespace-nowrap font-medium flex items-center justify-center gap-1.5 px-1 md:py-0 py-1">
        ...
        {/* Search — on sm+ uses order-2 to sit between Dropdown (order-1) and Cart (order-3) */}
        <label className="input rounded-full w-full sm:flex-1 sm:order-2 flex items-center gap-2 px-4 py-2.5 border border-cyan-500/40 bg-blue-950/60 text-cyan-100 shadow-[0_0_12px_rgba(6,182,212,0.1)] transition-all duration-200 focus-within:ring-2 focus-within:ring-cyan-400/60 focus-within:border-cyan-400/70 hover:border-cyan-400/50 hover:shadow-[0_0_16px_rgba(6,182,212,0.2)]">
