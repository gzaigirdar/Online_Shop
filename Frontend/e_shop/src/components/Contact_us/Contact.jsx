    ...
    <div className="min-h-screen w-full " id="contact">
      ...
      <div className="max-w-full mx-auto px-4 sm:px-4 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div className="bg-gray-300 rounded-2xl p-4">
          ...
          <p className="max-w-sm mt-4 mb-4 text-gray-900 font-light">
          ...
          <div className="flex items-center mt-8 space-x-2 text-gray-900">
            ...
            <span className="text-indigo-800">14th avenue glory road</span>
          </div>
          ...
          <div className="flex items-center mt-2 space-x-2 text-gray-900">
            ...
            <a className="text-indigo-800"   href="mailto:hello@company.com">hello@company.com</a>
          </div>
          ...
          <div className="flex items-center mt-2 space-x-2 text-gray-900">
            ...
            <a  className=" text-indigo-800" href="tel:11111111111">+51 11111111111</a>
          </div>
        </div>
      { showForm ?
        <div >
          <form  className="bg-gray-700 rounded-2xl px-5 py-5" onSubmit={handleSubmit(handlesubmit)}>
           ...
           focus:border-white"
            ...
            <div className="mb-3">
              ...
              className="w-full px-4 py-3 border-2 placeholder:text-gray-200 text-white
           bg-gray-900 rounded-lg outline-none h-36 focus:ring-4
           border-gray-600 focus:border-white ring-0"
            ...
            <button
              type="submit"
            className="w-full py-4 font-semibold text-black transition-colors bg-white rounded-lg
           hover:bg-gray-200 focus:outline-none focus:ring-offset-2 focus:ring
           focus:ring-gray-200 px-7"
            >
