...
function TestPage() {
  ...
  return (
    <div className="flex justify-center items-center p-2 sm:p-4">
      <div className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center m-2 sm:m-5 gap-3 sm:gap-4 w-full sm:w-3/5 lg:w-2/4 p-3 sm:p-5 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl shadow-indigo-500/10">
